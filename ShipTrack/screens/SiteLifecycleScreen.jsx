...
export default function SiteLifecycleScreen({
  ...
  const modeSub = mode === "DELIVERY"
    ? "Scan one assigned packet, capture its photo + fresh GPS proof, confirm it, then scan the next packet."
        ...
        <>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.resetBtn} onPress={resetPacket} disabled={submitting}>
              <Text style={styles.resetText}>Clear & scan next packet</Text>
            </TouchableOpacity>
          </View>
        </>
      ) : null}
