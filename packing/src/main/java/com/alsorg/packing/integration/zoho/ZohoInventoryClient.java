...
public class ZohoInventoryClient {
    ...
    private List<ZohoItemDTO> parseItems(JsonNode root) {
        ...
        for (JsonNode node : itemsNode) {
            ...
            JsonNode packageDetails = node.path("package_details");

            String length = packageDetails.path("length").asText("");
            String width  = packageDetails.path("width").asText("");
            String height = packageDetails.path("height").asText("");
            ...
            dto.setWeight(packageDetails.path("weight").asText("-"));
    ...
    public ZohoItemDTO fetchItemDetails(String itemId) {
        ...
        try {
            ...
            JsonNode packageDetails = item.path("package_details");
            ...
            dto.setRemarks(textOrDash(cf, "cf_remarks"));
            dto.setQuantity(parseQuantity(cf));
            System.out.println("CF DATA: " + cf.toPrettyString());
            System.out.println("PACKAGE DETAILS: " + packageDetails.toPrettyString());
            return dto;
