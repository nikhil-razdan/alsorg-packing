...
import static com.alsorg.packing.controller.matflow.MatFlowApiContract.API_VERSION_HEADER;
...
@ControllerAdvice(basePackages = "com.alsorg.packing.controller.matflow")
public class MatFlowApiVersionAdvice implements ResponseBodyAdvice<Object> {
    ...
    @Override public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        response.getHeaders().set(API_VERSION_HEADER, API_VERSION); return body;
    }
}
