...
public class LogisticsShift {
    ...
    @PrePersist
    private void initialiseCreatedAt() {
        if (createdAt == null) {
    ...
    public Integer getTotalLoaders() { return totalLoaders; }
    public void setTotalLoaders(Integer totalLoaders) { this.totalLoaders = totalLoaders; }
    ...
    public Double getDriverPerformance() { return driverPerformance; }
