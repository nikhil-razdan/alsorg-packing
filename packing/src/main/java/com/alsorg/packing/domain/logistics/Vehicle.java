...
public class Vehicle {
    ...
    public String getEmissionNorm() { return emissionNorm; }
    public void setEmissionNorm(String emissionNorm) { this.emissionNorm = emissionNorm; }

    public String getVehicleAge() {
        if (registrationDate != null) {
            LocalDate today = LocalDate.now(TimeZoneConfig.APP_ZONE);
            if (registrationDate.isAfter(today)) return "0 years 0 months";
            Period period = Period.between(registrationDate, today);
    ...
    public LocalDate getTaxValidUpto() { return taxValidUpto; }
    public void setTaxValidUpto(LocalDate taxValidUpto) { this.taxValidUpto = taxValidUpto; }
    public LocalDate getPermitValidUpto() { return permitValidUpto; }
    public void setPermitValidUpto(LocalDate permitValidUpto) { this.permitValidUpto = permitValidUpto; }
    public LocalDate getPuccValidUpto() { return puccValidUpto; }
    public void setPuccValidUpto(LocalDate puccValidUpto) { this.puccValidUpto = puccValidUpto; }
    public LocalDate getNationalPermitValidUpto() { return nationalPermitValidUpto; }
    public void setNationalPermitValidUpto(LocalDate nationalPermitValidUpto) { this.nationalPermitValidUpto = nationalPermitValidUpto; }
}
