...
public class VehicleExpense {
    ...
    @CollectionTable(name = "vehicle_expense_fields", joinColumns = @JoinColumn(name = "expense_id"))
    @OrderColumn(name = "sort_order")
    private List<VehicleExpenseField> fields = new ArrayList<>();
    ...
    public LocalDate getExpenseMonth() { return expenseMonth; }
    public void setExpenseMonth(LocalDate expenseMonth) { this.expenseMonth = expenseMonth; }
