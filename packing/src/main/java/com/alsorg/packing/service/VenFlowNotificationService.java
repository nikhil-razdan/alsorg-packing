...
public class VenFlowNotificationService {
    ...
    public void publishVendorDelay(
        ...
        String message =
                "Vendor delivery is overdue for PO "
                        + safe(entry.poNo)
                        + ". Vendor: "
                        + safe(entry.vendorName)
                        + ". Expected Date: "
    ...
    public void publishMaterialDelay(
        ...
        String message =
                "The overall expected date has crossed for PD "
                        + safe(entry.pdNo)
                        + ". Expected Date: "
                        + safe(entry.expectedDate)
                        + ". Current Stage: "
    ...
    private void notifyDirectors(
        ...
        for (User user : directorUsers()) {
            ...
            VenFlowNotification notification =
                    new VenFlowNotification();
