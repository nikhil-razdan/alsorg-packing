...
public class DashboardReportService {
    ...
    public DashboardStatsDTO getDashboardStats() {
         ...
         */
        long warehouseItems =
                repo.countWarehouseItems();

        long readyToDispatchItems =
                repo.countReadyToDispatchItems();

        long readyItems =
                repo.countReadyItems();
        ...
        long packedItems =
                repo.countPackedItems();

        long dispatchedItems =
                repo.countDispatchedItems();

        long pendingItems =
                repo.countPendingItems();

        long stickersGenerated =
                repo.countStickersGenerated();
         ...
         */
        long masterItems =
                repo.countMasterItems();

        long totalPackets =
                repo.countTotalPackets();

        long packetItems =
                repo.countPacketItems();

        long fullyPackedMasterItems =
                repo.countFullyPackedMasterItems();

        long partiallyPackedMasterItems =
                repo.countPartiallyPackedMasterItems();

        long unpackedMasterItems =
                repo.countUnpackedMasterItems();

        long packedPackets =
                repo.countPackedPackets();

        long pendingPackets =
                repo.countPendingPackets();

        long packetItemsWithSticker =
                repo.countPacketItemsWithSticker();

        long packetItemsPendingSticker =
                repo.countPacketItemsPendingSticker();

        long stickerReprints =
                repo.countStickerReprints();
         ...
         * =====================================================
         */
        long readyToStoreItems =
                repo.countReadyToStoreItems();

        long warehouseRequestedItems =
                repo.countWarehouseRequestedItems();

        long returnRequestedItems =
                repo.countReturnRequestedItems();

        long queuedItems =
                repo.countQueuedItems();
        ...
        long normalDispatchChallans =
                repo.countNormalDispatchChallans();

        long todayDispatchChallans =
                repo.countTodayDispatchChallans(
                        startOfToday,
                        startOfTomorrow
                );

        long runningTrips =
                repo.countRunningTrips();

        long endedTrips =
                repo.countEndedTrips();
         ...
         */
        long customChallans =
                repo.countCustomChallans();

        long todayCustomChallans =
                repo.countTodayCustomChallans(
                        startOfToday,
                        startOfTomorrow
                );

        long customChallanItems =
                repo.countCustomChallanItems();
         ...
         */
        long activeDrivers =
                repo.countActiveDrivers();

        long activeVehicles =
                repo.countActiveVehicles();

        long expiredFitness =
                repo.countExpiredFitness();

        long expiredInsurance =
                repo.countExpiredInsurance();

        long expiredPucc =
                repo.countExpiredPucc();
         ...
         * =====================================================
         */
        long masterItemsWithoutPackets =
                repo.countMasterItemsWithoutPackets();

        long packetsWithoutPacketItems =
                repo.countPacketsWithoutPacketItems();

        long packetItemsWithoutMaster =
                repo.countPacketItemsWithoutMaster();

        long dispatchedWithoutPacketItem =
                repo.countDispatchedWithoutPacketItem();

        long dispatchedWithoutChallan =
                repo.countDispatchedWithoutChallan();

        long dispatchedWithoutDriver =
                repo.countDispatchedWithoutDriver();

        long duplicateCurrentStickers =
                repo.countDuplicateCurrentStickers();

        long readyItemsStillInPkd =
                repo.countReadyItemsStillInPkd();

        long exceptionsCount =
                masterItemsWithoutPackets
    ...
    public List<DailyThroughputUserDTO> getTodayThroughputUsers(
        ...
        if (
                "dispatch".equals(normalizedType)
