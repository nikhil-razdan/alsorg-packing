...
public class InventoryReportWorkbookService {
                ...
                for (DispatchReportRow dispatch : rows) {
                        result.add(
                                        row(
                                                        ...
                                                        cleanExcelText(
                                                                        dispatch.getZohoItemId()),

                                                        cleanExcelText(
                                                                        dispatch.getPdNo()),

                                                        cleanExcelText(
                                                                        dispatch.getDrawingNo()),
                                                        ...
                                                        cleanExcelText(
                                                                        dispatch.getWarehouseCode()),

                                                        cleanExcelText(
                                                                        dispatch.getPacketNumber()),

                                                        cleanExcelText(
                                                                        dispatch.getPacketName()),
        ...
        private List<List<Object>> buildInsightRows(
                ...
                String busiestDate = dateWiseRows.isEmpty()
                                ? "-"
