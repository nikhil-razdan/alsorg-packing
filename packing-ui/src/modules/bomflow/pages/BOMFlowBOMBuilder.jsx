		...
		<Box sx={styles.BOM_viewShellSx}>
			<Box sx={styles.BOM_pageHeaderSx}>
				<Box>
					<Box sx={styles.BOM_statusLineSx}>
						<Chip
							label="PRJ-2024-089"
							size="small"
							sx={styles.BOM_projectChipSx}
						/>

						<Chip
							label="DRAFT"
							size="small"
							sx={styles.BOM_draftProjectChipSx}
						/>
					</Box>
				...
				<Card sx={styles.BOM_costCardSx}>
					...
					<Typography sx={styles.BOM_costValueSx}>
						₹ 45,250.00
					</Typography>
				</Card>
			</Box>
				...
				<Box sx={styles.BOM_sectionHeaderSx}>
					<Box sx={styles.BOM_sectionLeftSx}>
						<IconButton
							...
							sx={styles.BOM_sectionIconBtnSx}
						>
						...
						<Chip
							label="3 Items"
							size="small"
							sx={styles.BOM_countChipSx}
						/>
					</Box>

					<Box sx={styles.BOM_sectionRightSx}>
						<Box>
							<Typography sx={styles.BOM_sectionTotalLabelSx}>
								SECTION TOTAL
							</Typography>

							<Typography sx={styles.BOM_sectionTotalValueSx}>
								₹ 12,450.00
							</Typography>
						</Box>

						<IconButton sx={styles.BOM_sectionIconBtnSx}>
							<MoreVertIcon />
						</IconButton>
					</Box>
				</Box>
				...
				<Collapse in={metalOpen}>
					<Box sx={styles.BOM_tableSx}>
						...
						{metalRows.map((row) => {
							...
							return (
								<Box
									...
									sx={
										missing
											? styles.BOM_missingRowSx
											: styles.BOM_tableRowSx
									}
								>
									<Box sx={styles.BOM_deleteCellSx}>
									...
									<Box sx={styles.BOM_itemNameCellSx}>
										...
										<Typography
											sx={
												missing
													? styles.BOM_missingItemSx
													: styles.BOM_itemNameSx
											}
										>
											{row.item}
										</Typography>
									...
									<Typography sx={styles.BOM_cellTextSx}>
										{row.category}
									</Typography>
									...
									<Typography sx={styles.BOM_cellStrongSx}>
										{row.unit}
									</Typography>

									<Typography sx={styles.BOM_numberCellSx}>
										{row.qty}
									</Typography>

									{missing ? (
										<Box sx={styles.BOM_missingRateSx}>
											Missing
										</Box>
									) : (
										<Typography sx={styles.BOM_rateCellSx}>
											{row.rate}{" "}
						...
						<Box sx={styles.BOM_tableFooterSx}>
							<Button
								startIcon={<AddIcon />}
								sx={styles.BOM_addRowBtnSx}
							>
								Add Row
							</Button>

							<Typography sx={styles.BOM_validRateSx}>
								Valid Rates: 2/3
							</Typography>
						</Box>
					</Box>
