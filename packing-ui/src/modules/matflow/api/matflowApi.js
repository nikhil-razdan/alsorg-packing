...
export const matflowApi = {
	...
	listBomRoutes: (id) =>
		API.get(
			`${BASE}/boms/${requiredId(id, "BOM ID")}/routes`
		),
	...
	/*
	 * Existing Control Tower summary endpoint.
	 *
	 * GET:
	 * /api/matflow/tracker
	 */
	...
	/*
	 * NEW PROFESSIONAL TRACKER DETAIL
	 *
	 * Provides:
	 * - project / drawing
	 * - requisition
	 ...
	 * - bottleneck
	 * - timeline events
	 * - next department / location
	 *
	 * GET:
	 * /api/matflow/tracker/requisitions/{requisitionId}
	 */
	getTrackerDetail: (id) =>
		API.get(
