...
import MatFlowManagementDashboardContent from "./MatFlowManagementDashboardContent";
import {
    Detail,
    EmptyState,
    ErrorBox,
...
export function MatFlowDashboardPage() {
    /*
     * Dashboard-only redesign. The route remains inside the original
     * MatFlowLayout, so every existing sidebar/header/page keeps the exact
     * same shell, access rules and navigation behavior.
     */
    return <MatFlowManagementDashboardContent />;
}
