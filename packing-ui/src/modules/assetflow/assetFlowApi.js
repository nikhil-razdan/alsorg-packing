...
export const assetFlowApi = {
  ...
  workOrder: async (id) => data(await API.get(`/assetflow/work-orders/${id}`)),
  createWorkOrder: async (payload) => data(await API.post("/assetflow/work-orders", payload)),
  updateWorkOrder: async (id, payload) =>
    data(await API.put(`/assetflow/work-orders/${id}`, payload)),
  assignWorkOrder: async (id, payload) =>
    data(await API.post(`/assetflow/work-orders/${id}/assign`, payload)),
  changeStatus: async (id, payload) =>
    data(await API.post(`/assetflow/work-orders/${id}/status`, payload)),

  /* Legacy authenticated machine-QR endpoints remain for old printed labels. */
  qrEquipment: async (token) => data(await API.get(`/assetflow/qr/${token}`)),
  createQrComplaint: async (token, payload) =>
    data(await API.post(`/assetflow/qr/${token}/request`, payload)),

  equipment: async (params = {}) =>
    data(await API.get("/assetflow/equipment", { params: compactParams(params) })),
  equipmentOne: async (id) => data(await API.get(`/assetflow/equipment/${id}`)),
  createEquipment: async (payload) => data(await API.post("/assetflow/equipment", payload)),
  updateEquipment: async (id, payload) =>
    data(await API.put(`/assetflow/equipment/${id}`, payload)),
  rotateEquipmentQr: async (id) =>
    data(await API.post(`/assetflow/equipment/${id}/qr/rotate`)),
  ...
  updateTeam: async (id, payload) => data(await API.put(`/assetflow/teams/${id}`, payload)),
  ...
  updateReporter: async (id, payload) =>
    data(await API.put(`/assetflow/reporters/${id}`, payload)),
  ...
  updatePlan: async (id, payload) =>
    data(await API.put(`/assetflow/preventive-plans/${id}`, payload)),
