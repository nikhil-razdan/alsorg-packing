...
export default function VenFlowStoreDeskPage() {
			...
			<Box sx={pageHeaderSx}>
				<Box>
					...
					<Typography sx={pageSubSx}>
						Review veneer availability, send requirements to Purchase,
						receive material and inform Production.
					</Typography>
				</Box>
			</Box>
							...
							<Table size="small" sx={{ minWidth: 1250 }}>
								<TableHead>
									<TableRow>
										...
										<TableCell sx={tableHeadCellSx}>Store Status</TableCell>
